import { ArrowUpRight, Code2, Lightbulb, Layers3 } from "lucide-react";
import { Reveal } from "./Reveal";
import { SectionHeading } from "./SectionHeading";

const principles = [
  { icon: Lightbulb, title: "Curiosity", text: "Understand the system before reaching for the solution.", color: "bg-[#e8f0fe] text-[#1967d2]" },
      ...
      <div className="site-shell">
        ...
        <Reveal className="mt-12 rounded-[36px] bg-[#1d1d1f] p-8 sm:p-12 lg:p-16">
          <p className="max-w-5xl text-3xl font-medium leading-[1.22] tracking-[-0.045em] text-white sm:text-5xl lg:text-6xl">
            I enjoy turning <span className="text-[#5ac8fa]">complicated problems</span> into products that feel <span className="text-[#a7f3d0]">simple, fast, and genuinely useful.</span>
          </p>
