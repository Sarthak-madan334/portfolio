      ...
      <div className="site-shell relative z-10 grid min-h-[calc(100vh-74px)] items-center gap-12 py-16 lg:grid-cols-[1.08fr_0.92fr] lg:py-16">
        <div>
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .6 }}>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2"><p className="text-base font-semibold text-[#2563eb] dark:text-[#6da0ff] sm:text-lg">Full-stack developer</p><span className="hidden h-1 w-1 rounded-full bg-[#a0a0a5] sm:block" /><p className="flex items-center gap-2 text-xs font-medium text-[#77777d] dark:text-white/50"><span className="h-2 w-2 rounded-full bg-[#34c759]" /> Open to internships · 2026</p></div>
          </motion.div>
          <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.75, delay: 0.12, ease: [0.22, 1, 0.36, 1] }} className="mt-8 max-w-[780px] text-[clamp(3.4rem,5.25vw,5.5rem)] font-semibold leading-[0.92] tracking-[-0.07em] text-[#1d1d1f] dark:text-white">
            Full-stack products.
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.28 }} className="mt-7 max-w-xl text-base leading-7 text-[#6e6e73] dark:text-white/55 sm:text-lg sm:leading-8">
